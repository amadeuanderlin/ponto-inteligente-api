package com.anderlin.pontointeligente.api.controllers;
...
import com.anderlin.pontointeligente.api.dtos.LancamentoDto;
...
import com.anderlin.pontointeligente.api.response.Response;
import com.anderlin.pontointeligente.api.services.FuncionarioService;
import com.anderlin.pontointeligente.api.services.LancamentoService;
...
public class LancamentoController {
	...
	/**
	 * Converte os dados do DTO para lancamento.
	 * 
	 * @param lancamentoDto
	 * @return Lancamento
	 * @throws ParseException
	...
	private Lancamento converterDtoParaLancamento(LancamentoDto lancamentoDto, BindingResult result) throws ParseException {
		...
		if (lancamentoDto.getId().isPresent()) {
			Optional<Lancamento> lancamentoBD = this.lancamentoService.buscarPorId(lancamentoDto.getId().get());
			if (lancamentoBD.isPresent()) {
				lancamento = lancamentoBD.get();
			} else {
				result.addError(new ObjectError("lançamento", "Lançamento não encontrado para o ID: " + lancamentoDto.getId().get()));
			}
		} else {
